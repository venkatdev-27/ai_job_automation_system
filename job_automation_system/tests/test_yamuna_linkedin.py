...
def trigger_yamuna_linkedin_test():
    ...
    task_name = "tasks.linkedin_task.apply_to_job"
    ...
    print("Check logs with: docker logs -f celery-linkedin-1")


if __name__ == "__main__":
    trigger_yamuna_linkedin_test()
